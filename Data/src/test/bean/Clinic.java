...
public class Clinic {
    ...
    public DataIterable<Patient, Set<Patient>> patients = new DataIterable<>(new HashSet<>(), this);
    public DataIterable<User, Set<User>> users = new DataIterable<>(new HashSet<>(), this);
